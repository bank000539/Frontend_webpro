<template>
  <v-container fluid>
    ...
    <v-layout row>
      ...
      <v-flex xs7>
        <v-text-field label="Time" v-model="Book.time" :readonly="_readonly" type="time"></v-text-field>
      </v-flex>
    </v-layout>
    ...
    <v-layout row>
      ...
      <v-flex xs7>
        <v-select :items="status" :readonly="_readonly" v-model="Book.status" label="STATUS" style="text-transform: uppercase;"></v-select>
      </v-flex>
    </v-layout>
    <v-layout row>
      <v-flex xs3 offset-xs1>
      ...
      <v-flex xs7>
        <v-switch v-model="Book.checkout" :readonly="_readonly" :label="Book.checkout?'PASS':'NOT PASS'" color="success"></v-switch>
      </v-flex>
    </v-layout>
    <v-layout row>
      <v-flex xs3 offset-xs1>
      ...
      <v-flex xs7>
        <v-textarea name="input-7-1" :readonly="_readonly" v-model="Book.description" label="Description" ></v-textarea>
      </v-flex>
    </v-layout>
      ...
      <v-dialog v-model="dialog" persistent max-width="800">
        ...
        <v-card>
          ...
          <v-layout wrap>
            ...
            <v-flex xs7>
              <v-text-field v-model="Book.time"  readonly></v-text-field>
            </v-flex>
          </v-layout>
          <v-layout wrap>
            <v-flex xs3 offset-xs1>
